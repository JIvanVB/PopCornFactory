...
class MenuActivity : AppCompatActivity() {
    ...
    var peliculas = ArrayList<Pelicula>().apply {
    ...
    var series = ArrayList<Pelicula>().apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var p=findViewById<GridView>(R.id.gridview)
            p.adapter=AdapadorPeliculas(this,peliculas)
        p.setOnItemClickListener { parent, view, position, id ->
            startActivity(Intent(this,DetallePeliculaActivity::class.java)
                .putExtra("header",peliculas[position].header.toString())
                .putExtra("titulo",peliculas[position].titulo)
                .putExtra("sinop",peliculas[position].sinop)) }
        var s=findViewById<GridView>(R.id.gridviewS)
            s.adapter=AdapadorPeliculas(this,series)
    ...
    private class AdapadorPeliculas(context: Context, peliculas: ArrayList<Pelicula>): BaseAdapter(){
        ...
        override fun getItem(p0: Int): Any = peliculas[p0]
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            if (view == null) {
                view = LayoutInflater.from(contexto).inflate(R.layout.pelicula, parent, false)
        ...
        private class ViewHolder(view: View) {
            val titulo: TextView = view.findViewById(R.id.ptitulo)
            val imagen: ImageView = view.findViewById(R.id.pimagen)
        }
    }
}